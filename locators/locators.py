...
class BillingAddressLocators:
    ...
    save_address_button = (By.XPATH, "//div/form/div/p/button")
    message_div = (By.CLASS_NAME, "woocommerce-message")
...
class MyAccountPage:
    ...
    reg_email_input = (By.ID, "reg_email")
    reg_password_input = (By.ID, "reg_password")
    my_acc_link = (By.XPATH, "//li[@id = 'menu-item-22']//a")
    error_msg = (By.XPATH, "//div/div/div[1]/ul/li")
